            ...
            { 
		        ...
		        if(vehiculos!= null && vehiculos.length>0)
		        {
		            ...
		            {		                
		                ...
		                opcion_vehiculo =opcion_vehiculo+"<li class=\"vehicle\" position=\"\" latitude=\"\" longitude=\"\" vehicle=\""+vehiculo_id+"\" style=\"padding-left:0px; padding-top:5px; padding-bottom:5px;\"><table class=\"select_devices\" device_id=\""+vehiculo_id+"\"><tr><td height=\"17\" width=\"50\" align=\"center\"><img height=\"17\" src=\"" +icon+ "\"></td><td>" + vehiculo_name + "</td><td align=\"right\">" + vehiculo_name + "</td></tr></table></li>";
		            }
