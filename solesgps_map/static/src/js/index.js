            ...
            { 
		        ...
		        if(vehiculos!= null && vehiculos.length>0)
		        {
		            ...
		            {		                
		                ...
		                opcion_vehiculo =opcion_vehiculo+"<li class=\"vehicle\" position=\"\" latitude=\"\" longitude=\"\" vehicle=\""+vehiculo_id+"\" style=\"padding-left:0px; padding-top:5px; padding-bottom:5px;\"><table width=\"100%\" class=\"select_devices\" device_id=\""+vehiculo_id+"\"><tr><td height=\"17\" width=\"50\" align=\"center\"><img height=\"17\" src=\"" +icon+ "\"></td><td>" + vehiculo_name + "</td><td align=\"right\">" + vehiculo_name + "</td></tr></table></li>";
		            }
		...
		if(vehicle["st"]=="1" || vehicle["st"]=="-1")
		{
			...
			if(vehicle["se"]=="historyMap" || vehicle["se"]=="historyForm" || vehicle["ti"] >= localizacion_anterior[device_id]["ti"])
			{
				...
				{				    
					...
					icon="/solesgps_map/static/src/img/vehiculo_" +image+ "/i"+icon+ ".png";		    
